 ...
 * 
 */
@WebServiceClient(name = "LoginWS", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/loginWS/LoginWS?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGINWS_QNAME = new QName("http://service/", "LoginWS");
    ...
    public LoginWS getLoginWSPort() {
        return super.getPort(new QName("http://service/", "LoginWSPort"), LoginWS.class);
    }
    ...
    public LoginWS getLoginWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "LoginWSPort"), LoginWS.class, features);
    }
